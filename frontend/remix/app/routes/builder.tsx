...
import {  AccountMenu } from "@ui/index";
...
export default function _AppRoute() {
  return (
    <main className="bg-gray-100 dark:bg-gray-800 rounded-t-xl h-screen overflow-hidden relative">
...
export function Navigator(links: { title: string; to: string }[]) {
  return (
    <nav className="mt-6">
      <div>
        <a
