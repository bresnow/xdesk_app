...
export const SvgIcon =  {
    Search: ({ fill }: { fill?: string;}) => (
      <svg
        viewBox="0 0 24 24"
        className={`w-4 absolute text-${fill || "gray"}-400 top-1/2 transform translate-x-0.5 -translate-y-1/2 left-2`}
        stroke="currentColor"
        stroke-width="2"
        fill="none"
    ...
    Track: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.track.path} fill={fill} size={size} />;
    },

    Behance: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.behance.path} fill={fill} size={size} />;
    },

    Codepen: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.codepen.path} fill={fill} size={size} />;
    },

    Delicious: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.delicious.path} fill={fill} size={size} />;
    },

    DeviantArt: function ({ fill, size }: { fill?: string; size?: string }) {
      return (
        <IconSvg path={IconPaths.deviantArt.path} fill={fill} size={size} />
      );
    },

    Dribble: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.dribble.path} fill={fill} size={size} />;
    },

    Email: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.email.path} fill={fill} size={size} />;
    },

    Etsy: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.etsy.path} fill={fill} size={size} />;
    },

    Facebook: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.facebook.path} fill={fill} size={size} />;
    },

    Forrst: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.forrst.path} fill={fill} size={size} />;
    },

    GitHub: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.gitHub.path} fill={fill} size={size} />;
    },

    Keybase: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.keybase.path} fill={fill} size={size} />;
    },

    Instagram: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.instagram.path} fill={fill} size={size} />;
    },

    Last_fm: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.last_fm.path} fill={fill} size={size} />;
    },

    LinkedIn: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.linkedIn.path} fill={fill} size={size} />;
    },

    Reddit: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.reddit.path} fill={fill} size={size} />;
    },

    PayPal: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.payPal.path} fill={fill} size={size} />;
    },

    Pinterest: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.pinterest.path} fill={fill} size={size} />;
    },

    RSS: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.RSS.path} fill={fill} size={size} />;
    },

    SoundCloud: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.soundCloud.path} fill={fill} size={size} />;
    },

    StackOverf: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.stackOverflow.path} fill={fill} size={size} />;
    },

    StumbleUpon: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.stumbleUpon.path} fill={fill} size={size} />;
    },

    Tumblr: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.tumblr.path} fill={fill} size={size} />;
    },

    Twitter: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.twitter.path} fill={fill} size={size} />;
    },

    Vimeo: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.vimeo.path} fill={fill} size={size} />;
    },

    YouTube: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.youTube.path} fill={fill} size={size} />;
    },

    Yelp: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.yelp.path} fill={fill} size={size} />;
    },

    Foursquare: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.foursquare.path} fill={fill} size={size} />;
    },

    Spotify: function ({ fill, size }: { fill?: string; size?: string }) {
      return <IconSvg path={IconPaths.spotify.path} fill={fill} size={size} />;
    },
  };


export default function IconSvg({ path, fill, size, viewBox }: SVG) {
  return (
    <svg
      width={size || "15"}
      height={size || "15"}
